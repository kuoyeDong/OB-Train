...
//========================================================fcg for step
    Q_INVOKABLE QString getStepmotor_Angle(void);//fcg
    Q_INVOKABLE QString getStepmotor_Speed(void);//fcg
    //========================================================fcg for BDC
        Q_INVOKABLE QString getBDCmotor_Angle(void);//fcg
        Q_INVOKABLE QString getBDCmotor_Speed(void);//fcg

//========================================================ace for ESC and Carmotor

    Q_INVOKABLE QString getESC_Thro(void);
    Q_INVOKABLE QString getESC_Speed(void);
    Q_INVOKABLE QString getESC_Hall(void);
//========================================================ace for ESC
...
//=================================================================fcg for step
    Q_INVOKABLE void setPlatformInfo(int number,int motorHz,int motorSpeed,int motorAngle,int accSpeed);//fcg
//=================================================================fcg for BDC
    Q_INVOKABLE void setBDCPlatformInfo(int number,int motorHz,int motorSpeed,int motorAngle,int accSpeed);//fcg
//=================================================================ace for ESC
    Q_INVOKABLE void setESCMotorInfo(int PPM,int INC,int Dec,int Mode);//ace

    Q_INVOKABLE void setCarMotorInfo(int RPM,int KP,int KI ,int KD,int Meter,int ExperimentNum);//ace
